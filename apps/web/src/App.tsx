    ...
    <div className="app-shell maxwell-only-shell">
      <header className="topbar maxwell-only-topbar">
        <div className="brand-block">
          ...
          <div>
            <h1>EMMicro</h1>
            <p>L8.4 Aperture / Blocker Validation / L8.3 Surface Geometry / L7.8 Detector Round Trip</p>
          </div>
        </div>
        <div className="mode-badge">
          <Gauge size={16} />
          <span>Simulation Builder + Aperture FDTD Evidence</span>
          <strong>ordered grid/source/elements/target/compute/validate workflow, L8.4 long-slit/circular-pinhole/rectangular-aperture/opaque-blocker external FDTD fixtures with scalar reference and convergence diagnostics, L8.3 finite surface geometry export/import fixtures, L8.2 benchmark sweeps, and existing L7.8 detector round-trip diagnostics</strong>
        </div>
