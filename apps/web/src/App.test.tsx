...
describe("solver disclosure copy", () => {
  ...
  it("keeps the visible app shell focused on L9.9 advisor packets with L9.8 examples, L9.7 intake, L9.6 consistency, L9.5 evidence packs, L9.4 routing, L9.3 RCWA, L9.2 FDTD, L8.9 external run ingestion, and earlier diagnostics still reachable", () => {
    ...
    expect(app).toContain("L9.9 Advisor Review Packet / Evidence Dossier / L9.8 Example Library / L9.7 Build My Simulation / L9.6 Cross-Solver Consistency Bench");
    expect(app).toContain("Advisor Review Packet + Example Library + Build My Simulation + Cross-Solver Consistency + Evidence Auto-Pack + RCWA Preview + 2D Maxwell Sandbox");
    expect(app).toContain("L9.9 packages current evidence into advisor review dossiers");
