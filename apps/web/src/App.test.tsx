...
describe("solver disclosure copy", () => {
  ...
  it("keeps the visible app shell focused on L9.8 example library with L9.7 intake, L9.6 consistency, L9.5 evidence packs, L9.4 routing, L9.3 RCWA, L9.2 FDTD, L8.9 external run ingestion, and earlier diagnostics still reachable", () => {
    ...
    expect(app).toContain("L9.8 Example Library / Known Experiment Pack / L9.7 Build My Simulation / L9.6 Cross-Solver Consistency Bench / L9.5 Evidence Auto-Pack");
    expect(app).toContain("Example Library + Build My Simulation + Cross-Solver Consistency + Evidence Auto-Pack + RCWA Preview + 2D Maxwell Sandbox");
    expect(app).toContain("L9.8 loads known starter examples into existing L9.7/L9.4/L9.5/L9.6/RCWA/FDTD/diagnostic workflows");
