...
describe("solver disclosure copy", () => {
  ...
  it("keeps the visible app shell focused on L9.7 simulation intake with L9.6 consistency, L9.5 evidence packs, L9.4 routing, L9.3 RCWA, L9.2 FDTD, L8.9 external run ingestion, and earlier diagnostics still reachable", () => {
    ...
    expect(app).toContain("L9.7 Build My Simulation / Solver Method Decision Wizard / L9.6 Cross-Solver Consistency Bench / L9.5 Solver Router Evidence Auto-Pack / L9.4 Method Selection Matrix");
    expect(app).toContain("Build My Simulation + Solver Decision Wizard + Cross-Solver Consistency + Evidence Auto-Pack + RCWA Preview + 2D Maxwell Sandbox");
    expect(app).toContain("L9.7 guides problem intake into existing L9.4/L9.5/L9.6 workbenches and exports decision reports/templates");
    expect(app).toContain("does not add solver physics, automatic correctness proof, certified solver selection, or production RCWA/FDTD/FEM/BEM execution");
