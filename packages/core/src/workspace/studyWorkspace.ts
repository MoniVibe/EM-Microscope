...
export function l76CapabilitiesMatrix(): StudyCapability[] {
  return [
    ...
    executable("multi-element-optical-bench-chain", "Multi-element optical bench chain", "L8.5 ordered grid/source/elements/target/monitor scene graph with z-order controls, x-z cross-section, solver plan, scalar monitor stack, and report exports"),
...
export function studyBundleJson(
  ...
  return {
    schema: "emmicro.studyBundle.v1",
    appVersion: "L8.5 Multi-Element Optical Bench Propagation Chain / L7.8 Detector Round-Trip Acceptance Pack",
    manifest: {
      appVersion: "L8.5",
