...
export function studyBundleJson(
  ...
  return {
    schema: "emmicro.studyBundle.v1",
    appVersion: "L8.6 Process / Tolerance Runner + Multi-Element Optical Bench Editing / L7.8 Detector Round-Trip Acceptance Pack",
    manifest: {
      appVersion: "L8.6",
