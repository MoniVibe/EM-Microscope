...
export function l76CapabilitiesMatrix(): StudyCapability[] {
  return [
    ...
    executable("external-fdtd-variation-sweep", "External FDTD variation sweep", "L8.6 exports deterministic variation sweep manifests and imports summary receipts from optional external FDTD execution; no browser FDTD execution is implemented"),
    ...
    executable("external-fdtd-candidate-sweep", "External FDTD candidate sweep", "L8.7 exports robust candidate sweep manifests and imports summary receipts for supported finite geometry; no browser FDTD execution is implemented"),
...
export function studyBundleJson(
  ...
  return {
    schema: "emmicro.studyBundle.v1",
    appVersion: "L8.7 Robust Design Advisor + Process / Tolerance Runner + Multi-Element Optical Bench Editing / L7.8 Detector Round-Trip Acceptance Pack",
    manifest: {
      appVersion: "L8.7",
