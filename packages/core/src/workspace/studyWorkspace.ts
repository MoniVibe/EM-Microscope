...
export function l76CapabilitiesMatrix(): StudyCapability[] {
  return [
    ...
    executable("in-browser-2d-fdtd-sandbox", "In-browser 2D FDTD sandbox", "L9.0 runs a capped diagnostic CPU typed-array TMz sandbox over Ez/Hx/Hy with grid/object/step/monitor caps and exports sandbox reports/traces"),
