...
export function l76CapabilitiesMatrix(): StudyCapability[] {
  return [
    ...
    executable("in-browser-2d-fdtd-sandbox", "In-browser 2D FDTD sandbox", "L9.1 runs a capped diagnostic CPU typed-array TMz sandbox over Ez/Hx/Hy with grid/object/step/monitor caps and exports sandbox reports/traces"),
    executable("fdtd2d-stability-diagnostics", "2D FDTD stability diagnostics", "L9.1 computes CFL/dt/grid safety, max Ez/Hx/Hy, NaN/Infinity guards, energy trend, boundary-loss estimate, memory estimate, and stability report exports"),
    executable("fdtd2d-validation-fixtures", "2D FDTD validation fixtures", "L9.1 runs empty-space, PEC-like wall, dielectric interface, absorbing slab, point-source symmetry, and qualitative slit diagnostics with finite-trace checks"),
    executable("fdtd2d-convergence-diagnostics", "2D FDTD convergence diagnostics", "L9.1 runs bounded grid refinement diagnostics with residual-vs-grid rows and convergence CSV exports"),
    ...
    unavailable("webgpu-fdtd-acceleration", "WebGPU FDTD acceleration"),
