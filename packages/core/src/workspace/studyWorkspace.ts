...
export function l76CapabilitiesMatrix(): StudyCapability[] {
  return [
    ...
    executable("simulation-intake-wizard", "Solver Method Decision Wizard / Simulation Intake", "L9.7 guides Problem Type, Desired Output, Geometry, Materials, and Rigor/Evidence answers into deterministic L9.4 route decisions, L9.5 evidence tasks, L9.6 consistency cases, generated templates, and unsupported gap reports"),
    executable("simulation-intake-decision-export", "Simulation intake decision export", "L9.7 exports simulation_decision_report.md/json, simulation_decision_matrix.csv, generated_scene_template.json, and wizard_answers.json without adding solver physics or certifying solver choice"),
    executable("advisor-review-packet", "Advisor Review Packet", "L9.9 generates deterministic advisor review dossiers with selected examples/scenes, solver routes, evidence tasks, claim ledger rows, completeness checks, gap tables, review questions, receipts, and Markdown/JSON/CSV/HTML exports"),
    executable("evidence-dossier-generation", "Evidence dossier generation", "L9.9 packages existing L9.8/L9.7/L9.6/L9.5/L8.9 evidence into review-ready reports without adding solver physics or certification claims"),
    executable("guided-example-library", "Guided Example Library", "L9.8 searches and filters deterministic known example cards, preserves example hashes, and loads starter workflows into existing L9.7/L9.4/L9.5/L9.6/RCWA/FDTD/diagnostic routes"),
    executable("known-experiment-starter-packs", "Known experiment starter packs", "L9.8 includes planar TMM, scalar diffraction, RCWA, 2D FDTD, external FDTD, camera/MTF diagnostics, evidence/robustness, and unsupported/gap starter examples with expected physics and evidence tasks"),
    executable("unsupported-example-gap-reports", "Unsupported examples / gap reports", "L9.8 loads unsupported curved/freeform/CAD examples as gap reports with required evidence and safe approximations, not as executable solver green lights"),
    ...
    unavailable("certified-validation-report", "Certified validation report"),
    unavailable("automatic-correctness-proof", "Automatic correctness proof"),
