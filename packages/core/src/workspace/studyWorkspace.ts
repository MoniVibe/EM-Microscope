...
export function studyBundleJson(
  ...
  return {
    schema: "emmicro.studyBundle.v1",
    appVersion: "L8.5.1 Element Inspector + Multi-Element Optical Bench Editing / L7.8 Detector Round-Trip Acceptance Pack",
    manifest: {
      appVersion: "L8.5.1",
