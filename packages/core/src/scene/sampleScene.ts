import { migrateSceneV2ToV3, migrateSceneV3ToV4, type Scene, type SceneV1, type SceneV2 } from "./schema";
...
export const sampleL1Scene: Scene = migrateSceneV3ToV4(migrateSceneV2ToV3(sampleL1SceneV2));
