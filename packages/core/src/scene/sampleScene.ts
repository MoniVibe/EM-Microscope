import { migrateSceneV2ToV3, migrateSceneV3ToV4, migrateSceneV4ToV5, migrateSceneV5ToV6, migrateSceneV6ToV7, type Scene, type SceneV1, type SceneV2 } from "./schema";
...
export const sampleL1Scene: Scene = migrateSceneV6ToV7(migrateSceneV5ToV6(migrateSceneV4ToV5(migrateSceneV3ToV4(migrateSceneV2ToV3(sampleL1SceneV2)))));
