...
export const l85OpticalBenchBoundary = [
  ...
  "No production in-browser FDTD execution, arbitrary CAD/freeform geometry solve, general arbitrary 3D Maxwell, FEM/BEM/RCWA, production metal optics model, curved material lens solve, conformal multilayer curved coating solver, sensor-stack EM, digital twin calibration, hardware control, required WebGPU execution, or manufacturing certification is implemented; L9.2's separate 2D TMz sandbox is diagnostic only with optional WebGPU acceleration where supported."
] as const;
