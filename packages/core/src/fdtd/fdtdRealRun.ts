...
export const l89RealExternalRunBoundary = [
  "L8.9 exports a deterministic external-run pack and imports user-produced FDTD artifacts; this external Meep/FDTD workflow executes outside the browser.",
  ...
  "No production in-browser FDTD, arbitrary 3D Maxwell/CAD execution, FEM/BEM/RCWA, production solver certification, digital twin, lab accreditation, hardware control, manufacturing certification, or sensor-stack EM is claimed."
] as const;
...
function runPackReadme(bundle: FdtdExportBundle, runConfig: RealExternalRunConfig, commands: RealExternalRunPack["commands"]): string {
  return [
    ...
    "This external-run pack is executed outside the web app and does not require Python, Meep, or native solver dependencies inside the browser.",
    "",
    "## Files",
    "",
