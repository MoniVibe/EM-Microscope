...
export const l81FdtdBoundary = [
  "External FDTD export/import only; this Meep/helper workflow does not execute production FDTD in the browser.",
  ...
  "L8.5 multi-element optical bench export/import composes supported finite geometry into deterministic external FDTD helper scenes with monitor definitions and receipts; it is not an in-browser FDTD solve.",
...
export function exportMeepScriptForFdtdManifest(manifest: FdtdSceneManifest): FdtdMeepScriptExport {
  ...
  const python = [
    ...
    "# Optional external helper only; this Meep/production FDTD helper is executed outside the browser.",
